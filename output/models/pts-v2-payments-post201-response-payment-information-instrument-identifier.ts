 ...
 * 
 * @export
 * @interface PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier
 */
export interface PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier {
     ...
     * @type {string}
     * @memberof PtsV2PaymentsPost201ResponsePaymentInformationInstrumentIdentifier
     */
    id?: string;
    /**
