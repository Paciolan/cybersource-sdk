 ...
 * 
 * @export
 * @interface PtsV2IncrementalAuthorizationPatch201ResponseOrderInformationAmountDetails
 */
export interface PtsV2IncrementalAuthorizationPatch201ResponseOrderInformationAmountDetails {
    /**
     ...
     * @type {string}
     * @memberof PtsV2IncrementalAuthorizationPatch201ResponseOrderInformationAmountDetails
     */
    totalAmount?: string;
    /**
