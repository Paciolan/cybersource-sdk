 ...
 * 
 * @export
 * @interface Riskv1authenticationresultsPaymentInformationFluidData
 */
export interface Riskv1authenticationresultsPaymentInformationFluidData {
    /**
     ...
     * @type {string}
     * @memberof Riskv1authenticationresultsPaymentInformationFluidData
     */
    value?: string;
    /**
