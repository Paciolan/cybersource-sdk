 ...
 * 
 * @export
 * @interface PaymentinstrumentsPaymentInstrumentTokenIdBody
 */
export interface PaymentinstrumentsPaymentInstrumentTokenIdBody {
    /**
     * 
     * @type {Tmsv2customersEmbeddedDefaultPaymentInstrumentLinks}
     * @memberof PaymentinstrumentsPaymentInstrumentTokenIdBody
     */
