 ...
 * 
 * @export
 * @interface ShippingaddressesShippingAddressTokenIdBody
 */
export interface ShippingaddressesShippingAddressTokenIdBody {
    /**
     * 
     * @type {Tmsv2customersEmbeddedDefaultShippingAddressLinks}
     * @memberof ShippingaddressesShippingAddressTokenIdBody
     */
