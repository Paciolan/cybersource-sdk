 ...
 * 
 * @export
 * @interface PtsV2IncrementalAuthorizationPatch201ResponsePaymentInformationAccountFeatures
 */
export interface PtsV2IncrementalAuthorizationPatch201ResponsePaymentInformationAccountFeatures {
     ...
     * @type {string}
     * @memberof PtsV2IncrementalAuthorizationPatch201ResponsePaymentInformationAccountFeatures
     */
    category?: string;
}
