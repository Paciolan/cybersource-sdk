 ...
 */
import { Ptsv2paymentsOrderInformationBillToCompany } from './ptsv2payments-order-information-bill-to-company';
/**
 * 
 * @export
 * @interface Ptsv2paymentsOrderInformationBillTo
 */
export interface Ptsv2paymentsOrderInformationBillTo {
     ...
     * @type {string}
     * @memberof Ptsv2paymentsOrderInformationBillTo
     */
    firstName?: string;
    /**
