 ...
 * 
 * @export
 * @interface PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions
 */
export interface PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions {
     ...
     * @type {string}
     * @memberof PtsV2CreditsPost201ResponseProcessingInformationBankTransferOptions
     */
