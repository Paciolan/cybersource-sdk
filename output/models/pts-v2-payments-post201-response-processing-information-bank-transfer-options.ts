 ...
 * 
 * @export
 * @interface PtsV2PaymentsPost201ResponseProcessingInformationBankTransferOptions
 */
export interface PtsV2PaymentsPost201ResponseProcessingInformationBankTransferOptions {
     ...
     * @type {string}
     * @memberof PtsV2PaymentsPost201ResponseProcessingInformationBankTransferOptions
     */
