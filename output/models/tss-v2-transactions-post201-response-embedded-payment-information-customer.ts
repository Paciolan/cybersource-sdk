 ...
 * 
 * @export
 * @interface TssV2TransactionsPost201ResponseEmbeddedPaymentInformationCustomer
 */
export interface TssV2TransactionsPost201ResponseEmbeddedPaymentInformationCustomer {
    /**
     ...
     * @type {string}
     * @memberof TssV2TransactionsPost201ResponseEmbeddedPaymentInformationCustomer
     */
    customerId?: string;
}
