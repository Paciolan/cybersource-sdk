 ...
 */
import { Ptsv2paymentsProcessingInformationAuthorizationOptionsInitiator } from './ptsv2payments-processing-information-authorization-options-initiator';
/**
 * 
 * @export
 * @interface Ptsv2paymentsProcessingInformationAuthorizationOptions
 */
export interface Ptsv2paymentsProcessingInformationAuthorizationOptions {
     ...
     * @type {string}
     * @memberof Ptsv2paymentsProcessingInformationAuthorizationOptions
     */
    authType?: string;
    /**
