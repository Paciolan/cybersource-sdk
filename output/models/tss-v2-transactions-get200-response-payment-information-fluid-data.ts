 ...
 * 
 * @export
 * @interface TssV2TransactionsGet200ResponsePaymentInformationFluidData
 */
export interface TssV2TransactionsGet200ResponsePaymentInformationFluidData {
    /**
     ...
     * @type {string}
     * @memberof TssV2TransactionsGet200ResponsePaymentInformationFluidData
     */
    descriptor?: string;
}
